'''
  Para la solución de este problema debes implementar la función `list_partition`
...
def list_partition(list1: SingleLinkedList, list2: SingleLinkedList) -> SingleLinkedList:
  '''
