'''
  Para la solución de este problema debes implementar la función `remove_nth_last_node`
...
def remove_nth_last_node(list: SingleLinkedList, n: int) -> SingleLinkedList:
  '''
