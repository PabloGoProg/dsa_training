'''
  Para la solución de este problema debes implementar la función `adding_with_lists`
...
def adding_with_lists(list1: SingleLinkedList, list2: SingleLinkedList) -> SingleLinkedList:
  '''
