'''
  Para la solución de este problema debes implementar la función `reverse_gorups_of_nodes`
...
def reverse_gorups_of_nodes(list: SingleLinkedList, k: int) -> SingleLinkedList:
  '''
