'''
  Para la solución de este problema debes implementar la función `point_to_next_bigger_node`
...
def point_to_next_bigger_node(list: SingleLinkedList) -> SingleLinkedList:
  '''
